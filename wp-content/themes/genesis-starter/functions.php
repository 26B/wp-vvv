...
define( 'CHILD_THEME_URL', 'https://github.com/xipasduarte/wp-seed' );
...
\add_action( 'after_setup_theme', function () {
	$components = array(
		'scripts'    => new \WPSeed\WP\Theme\GenesisStarter\Scripts(),
		'shortcodes' => new \WPSeed\WP\Theme\GenesisStarter\Shortcodes(),
		'styles'     => new \WPSeed\WP\Theme\GenesisStarter\Styles(),
	);
	 ...
	 */
	$components = \apply_filters( 'GenesisStarter_components', $components );
